...
3. **Access the Chatbot**: After the containers are up, you can access the chatbot frontend from the **Chatbot-widget-main** folder by hosting it on a local or remote server. More details can be found inside `instructions.md` and `readme.md` inside this folder.
